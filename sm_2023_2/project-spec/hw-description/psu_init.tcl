...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0068 0x013F3F07 0x01011E00
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01010502
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01011E00
    ...
    mask_write 0XFF5E00C0 0x013F3F07 0x01010503
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01011402
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
    ...
    mask_write 0XFD1A00C0 0x01003F07 0x01000302
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070070 0x00000017 0x00000014
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x09640301
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0609080D
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048D8209
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000B07
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x08261109
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00381109
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000C11
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000864
    ...
    mask_write 0XFD080F00 0xFFFFFFFF 0x40800604
    ...
    mask_write 0XFD080F04 0xFFFFFFFF 0x00007FFF
    ...
    mask_write 0XFD080F08 0xFFFFFFFF 0x00000000
    ...
    mask_write 0XFD080F0C 0xFFFFFFFF 0x3F000008
    ...
    mask_write 0XFD081504 0xFFFFFFFF 0x000E0000
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180028 0x000000FE 0x00000040
    ...
    mask_write 0XFF18002C 0x000000FE 0x00000040
    ...
    mask_write 0XFF180208 0x000FFFFF 0x0000007F
    ...
    mask_write 0XFF180144 0x03400FFF 0x03400FFF
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x03400FFF
    ...
    mask_write 0XFF180154 0x03FFFFFF 0x000FFFFF
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x00003FFC
    ...
    mask_write 0XFF180160 0x03FFC000 0x03FFC000
    ...
    mask_write 0XFF18017C 0x00000FFF 0x00000FFF
    ...
    mask_write 0XFF180180 0x03FFFFFF 0x00000FFF
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x0000007E 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
    ...
    mask_write 0XFF180320 0x33843384 0x00801284
		# : SD0 BASE CLOCK
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410008 0x0000001F 0x0000000F
    ...
    mask_write 0XFD40A368 0x000000FF 0x000000E0
    ...
    mask_write 0XFD40A370 0x000000FF 0x000000C9
    ...
    mask_write 0XFD40A374 0x000000FF 0x000000D2
    ...
    mask_write 0XFD40A37C 0x000000B3 0x000000B0
		# Register : L2_PLL_FBDIV_FRAC_3_MSB @ 0XFD40A360</p>
    ...
    mask_write 0XFD40A360 0x00000040 0x00000040
    ...
    mask_write 0XFD40906C 0x0000000F 0x0000000F
    ...
    mask_write 0XFD4080F4 0x0000000B 0x0000000B
    ...
    mask_write 0XFD4098F8 0x000000FF 0x0000007D
    ...
    mask_write 0XFD4098FC 0x000000FF 0x0000007D
    ...
    mask_write 0XFD409990 0x000000FF 0x00000001
    ...
    mask_write 0XFD409924 0x000000FF 0x0000009C
    ...
    mask_write 0XFD409928 0x000000FF 0x00000039
		# Register : L2_TM_ILL11 @ 0XFD40998C</p>
    ...
    mask_write 0XFD40998C 0x000000F0 0x00000020
    ...
    mask_write 0XFD409900 0x000000FF 0x0000007D
    ...
    mask_write 0XFD40992C 0x000000FF 0x00000064
    ...
    mask_write 0XFD410014 0x00000007 0x00000002
		# : CHECKING PLL LOCK
		# : ENABLE SERIAL DATA MUX DEEMPH
		# Register : L2_TX_ANA_TM_118 @ 0XFD4081D8</p>
    ...
    mask_write 0XFD4081D8 0x00000001 0x00000001
		# : CDR AND RX EQUALIZATION SETTINGS
		# Register : L2_TM_CDR5 @ 0XFD409C14</p>
    ...
    mask_write 0XFD409C14 0x000000FF 0x000000E6
		# Register : L2_TM_CDR16 @ 0XFD409C40</p>
    ...
    mask_write 0XFD409C40 0x0000001F 0x0000000C
		# Register : L2_TM_EQ0 @ 0XFD40994C</p>
    ...
    mask_write 0XFD40994C 0x00000020 0x00000020
		# Register : L2_TM_EQ1 @ 0XFD409950</p>
    ...
    mask_write 0XFD409950 0x00000007 0x00000006
		# : GEM SERDES SETTINGS
		# : ENABLE PRE EMPHAIS AND VOLTAGE SWING
		# Register : L2_TX_ANA_TM_18 @ 0XFD408048</p>
    ...
    mask_write 0XFD408048 0x000000FF 0x00000001
}
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD3D0100 0x00000003 0x00000002
		# Register : RST_FPD_TOP @ 0XFD1A0100</p>
...
set psu_afi_config {
    ...
    mask_write 0XFD615000 0x00000F00 0x00000000
